...
impl HashIconExt for HashIcon {
    fn to_html(&self) -> RawHtml<String> {
        html! {
            @match self {
                Self::Bomb => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBombs.png"));
                Self::Bombos => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBombos.png"));
                Self::Boomerang => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBoomerang.png"));
                Self::Bow => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBow.png"));
                Self::Hookshot => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashHookshot.png"));
                Self::Mushroom => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashMushroom.png"));
                Self::Pendant => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashPendant.png"));
                Self::Powder => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashMagicPowder.png"));
                Self::Rod => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashIceRod.png"));
                Self::Ether => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashEther.png"));
                Self::Quake => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashQuake.png"));
                Self::Lamp => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashLamp.png"));
                Self::Hammer => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashHammer.png"));
                Self::Shovel => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashShovel.png"));
                Self::Ocarina => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashFlute.png"));
                Self::BugNet => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBugnet.png"));
                Self::Book => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBook.png"));
                Self::Bottle => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashEmptyBottle.png"));
                Self::Potion => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashGreenPotion.png"));
                Self::Cane => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashSomaria.png"));
                Self::Cape => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashCape.png"));
                Self::Mirror => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashMirror.png"));
                Self::Boots => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBoots.png"));
                Self::Gloves => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashGloves.png"));
                Self::Flippers => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashFlippers.png"));
                Self::Pearl => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashMoonPearl.png"));
                Self::Shield => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashShield.png"));
                Self::Tunic => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashTunic.png"));
                Self::Heart => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashHeart.png"));
                Self::Map => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashMap.png"));
                Self::Compass => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashCompass.png"));
                Self::Key => img(class = "hash-icon", alt = self.to_string(), src = static_url!("hash-icon/HashBigKey.png"));
            }
        }
    }
}
